...
export interface UXDCouncilTokenInterface extends utils.Interface {
  functions: {
...
export interface UXDCouncilToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UXDCouncilTokenInterface;
