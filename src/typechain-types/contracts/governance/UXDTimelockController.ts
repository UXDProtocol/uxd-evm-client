...
export interface UXDTimelockControllerInterface extends utils.Interface {
  functions: {
...
export interface UXDTimelockController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UXDTimelockControllerInterface;
