...
export interface IUXDControllerInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "mint" | "redeem" | "redeemable"
  ): FunctionFragment;
...
export interface IUXDController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUXDControllerInterface;
  ...
  functions: {
    ...
    redeem(
      ...
      minAssetAmountOut: PromiseOrValue<BigNumberish>,
      receiver: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
