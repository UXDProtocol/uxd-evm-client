...
export interface TestPerpDepositoryInterface extends utils.Interface {
  functions: {
...
export interface TestPerpDepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPerpDepositoryInterface;
