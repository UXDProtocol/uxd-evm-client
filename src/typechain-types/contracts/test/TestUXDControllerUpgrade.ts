...
export interface TestUXDControllerUpgradeInterface extends utils.Interface {
  functions: {
...
export interface TestUXDControllerUpgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestUXDControllerUpgradeInterface;
