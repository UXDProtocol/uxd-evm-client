...
export interface TestPerpDepositoryUpgradeInterface extends utils.Interface {
  functions: {
...
export interface TestPerpDepositoryUpgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPerpDepositoryUpgradeInterface;
