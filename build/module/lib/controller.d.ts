...
export declare class UXDController {
    ...
    mint(collateral: string, ethAmount: BigNumber, slippage: BigNumber, signer: Signer): Promise<any>;
    redeem(collateral: string, uxdAmount: BigNumber, slippage: BigNumber, signer: Signer): Promise<any>;
    mintWithEth(ethAmount: BigNumber, slippage: BigNumber, signer: Signer): Promise<any>;
    redeemEth(uxdAmount: BigNumber, slippage: BigNumber, signer: Signer): Promise<any>;
